"""
Django settings for productapi_45244 project.
...
ROOT_URLCONF = 'productapi_45244.urls'
...
WSGI_APPLICATION = 'productapi_45244.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "productapi_45244 API",
    "DESCRIPTION": "API documentation for productapi_45244 App",
    "VERSION": "v1",
}
